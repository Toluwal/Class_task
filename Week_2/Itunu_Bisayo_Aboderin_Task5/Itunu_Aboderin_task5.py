...
current_month_number = str(input("What is the current month number (1-12): "))
current_day_number = str(input("What is the current day number (1-7) ?: "))
attendance_tracker =(weeks, months, student, gender, course_track, current_month_number, current_day_number)
print(weeks)
print(months)
print(attendance_tracker)
print(f"Attendance tracker:\nweeks: \t\t\t{weeks}\nmonths: \t\t{months}\nstudent: \t\t{student}\ngender: \t\t{gender}\ncourse track: \t\t{course_track}\ncurrent month number: \t{current_month_number}\ncurrent day number: \t{current_month_number} ")